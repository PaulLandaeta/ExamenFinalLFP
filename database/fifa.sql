CREATE DATABASE  IF NOT EXISTS `fifa` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `fifa`;
...
CREATE TABLE `other_details` (
  ...
  UNIQUE KEY `id` (`id`),
  CONSTRAINT `other_details_ibfk_1` FOREIGN KEY (`player_id`) REFERENCES `personal_details` (`player_id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
-- Dump completed on 2020-03-23 14:43:40
